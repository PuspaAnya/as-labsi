...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 col-lg-6 mx-auto">
        <div class="card-header py-3 mx-auto">
            <h5 class="m-0 font-weight-bold">Upload Jadwal Praktikum LABSI</h5>
        </div>
        <div class="card-body">
            <form enctype="multipart/form-data" action="<?php echo base_url('admin/proses_jadwalpraktikum'); ?>" method="POST">
                ...
                <div class="row justify-content-start">
                    <div class=" mt-2">
                        <a href="<?= base_url('admin/jadwal_praktikum') ?>" class="btn"><i class="fas fa-fw fa-arrow-left"></i> Kembali</a>
                    </div>
                    <div class=" mt-2 ml-3">
