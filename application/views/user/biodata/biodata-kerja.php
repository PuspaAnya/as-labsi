                ...
                <div class="row col-lg-12 mx-auto justify-content-center">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="row  justify-content-start">
                            <a href="<?= base_url('user/editBiodata') ?>" class="btn btn-outline-primary m-2"><i class="fas fa-fw fa-user-edit"></i> Ubah Data</a>

                            <a href="<?= base_url('user/ubah_Password') ?>" class="btn m-2"><i class="fas fa-fw fa-key"></i> Ubah Password</a>
                        </div>
                    </div>
                </div>
            </div>
